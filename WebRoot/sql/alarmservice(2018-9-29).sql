/*
 ...
 Source Schema         : alarmservice

 Target Server Type    : MySQL
 Target Server Version : 50721
 File Encoding         : 65001

 Date: 29/09/2018 08:52:56
*/
...
-- ----------------------------
-- Table structure for alarm_attr
-- ----------------------------
DROP TABLE IF EXISTS `alarm_attr`;
CREATE TABLE `alarm_attr`  (
  `deviceType` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `alarmCode` int(10) NOT NULL,
  `alarmType` int(10) NULL DEFAULT NULL,
  `alarmSeverity` int(10) NULL DEFAULT NULL,
  `alarmDescription` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alarmCause` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alarmCause_en` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `limitStrategy` int(10) NULL DEFAULT NULL COMMENT '0表示不限流，1表示按次数限流，2表示按时间限流',
  `autoClearEnable` int(10) NULL DEFAULT NULL,
  `autoClearTimeout` int(10) NULL DEFAULT NULL COMMENT '以秒为单位',
  `alarmSuppress` int(10) NULL DEFAULT NULL,
  PRIMARY KEY (`deviceType`, `alarmCode`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of alarm_attr
-- ----------------------------
INSERT INTO `alarm_attr` VALUES ('BLE', 1, 1, 200, '', '货物异常移动（非法叉车）', 'Bluetooth illegal goods movement alarm', '无', '', 0, 0, 60, 1);
INSERT INTO `alarm_attr` VALUES ('BLE', 2, 2, 400, '', '货物异常移动出室内仓库大门（非法叉车）', 'Bluetooth goods out of the warehouse alarm', '无', '', 0, 0, 60, 1);
INSERT INTO `alarm_attr` VALUES ('BLE', 3, 3, 500, '', '货物异常移动出室外仓库大门（非法叉车）', 'Bluetooth goods out of the warehouse door alarm', '无', '', 0, 0, 60, 1);
INSERT INTO `alarm_attr` VALUES ('BLE', 4, 4, 500, '', '货物异常移动出室外仓库大门（非法叉车）', 'Executive Bluetooth goods out of the warehouse door alarm', '无', '', 0, 0, 60, 1);
INSERT INTO `alarm_attr` VALUES ('CCS', 1, 1, 200, '', '货物非法移动告警', 'Illegal movement of goods', '无', '', 0, 0, 60, 1);
INSERT INTO `alarm_attr` VALUES ('CCS', 2, 2, 400, '', '货物非法移动跨库区告警', 'Goods out of the warehouse alarm', '无', '', 0, 0, 60, 1);
INSERT INTO `alarm_attr` VALUES ('CCS', 3, 3, 500, '', '货物出室外仓库大门告警', 'Cargo warehouse door alarm', '无', '', 0, 0, 60, 1);
INSERT INTO `alarm_attr` VALUES ('CCS', 4, 4, 500, '', '货物出室外仓库大门告警', 'Executive goods out of the warehouse door alarm', '无', '', 0, 0, 60, 1);
...
CREATE TABLE `alarm_log`  (
  `serialNumber` bigint(10) NOT NULL AUTO_INCREMENT,
  `alarmSource` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alarmCode` int(11) NULL DEFAULT NULL,
  `raisedTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lastChangeTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ackTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ackUserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `clearTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `clearUserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `additionPairs` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `alarm_log` VALUES (2475, 'BLE/A1BF298B08491D', 1, '2018-08-27 22:18:18', '2018-08-28 18:47:53', NULL, NULL, NULL, NULL, '{\"PBNo\":\"di08263\",\"bleId\":\"A1BF298B08491D\",\"bundleNo\":3,\"target\":\"\",\"belongWhId\":\"洋山仓库\",\"productId\":\"低密度聚乙烯\"}', NULL);
...
-- ----------------------------
INSERT INTO `alarm_severity` VALUES (100, 'indeterminate');
INSERT INTO `alarm_severity` VALUES (200, 'warning');
INSERT INTO `alarm_severity` VALUES (300, 'minor');
INSERT INTO `alarm_severity` VALUES (400, 'major');
INSERT INTO `alarm_severity` VALUES (500, 'critical');
...
-- ----------------------------
INSERT INTO `alarm_type` VALUES (1, '1');
INSERT INTO `alarm_type` VALUES (2, '2');
INSERT INTO `alarm_type` VALUES (3, '3');
INSERT INTO `alarm_type` VALUES (4, '4');
...
INSERT INTO `sys_menu` VALUES (2, '用户管理', 'user/tolistUsersPage.do', '1', '1', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (3, '角色权限管理', 'role/toRoleListPage.do', '1', '2', 'menu-icon fa fa-key orange', '1', 1);
INSERT INTO `sys_menu` VALUES (4, '菜单管理', 'menu/listAllMenu.do', '1', '3', 'menu-icon fa fa-folder-open-o brown', '1', 1);
INSERT INTO `sys_menu` VALUES (5, '日志管理', 'fhlog/toListLogsPage.do', '1', '4', 'menu-icon fa fa-book blue', '1', 1);
INSERT INTO `sys_menu` VALUES (6, '拓扑管理', '#', '0', '2', 'menu-icon fa fa-tree green', '2', 1);
INSERT INTO `sys_menu` VALUES (7, '机柜拓扑图', 'carbinet/listCarbinetAllMenu.do', '6', '1', 'menu-icon fa fa-tree blue', '1', 1);
INSERT INTO `sys_menu` VALUES (8, '终端用户分布图', 'department/listAllDepartment.do?DEPARTMENT_ID=0', '6', '2', 'menu-icon fa fa-tree blue', '1', 1);
INSERT INTO `sys_menu` VALUES (9, '故障管理', '#', '0', '3', 'menu-icon fa fa-laptop pink', '2', 1);
INSERT INTO `sys_menu` VALUES (10, '实时告警监控', 'realTimeAlarm/toRealTimeAlarmPage.do', '9', '1', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (11, '历史告警查询', 'historyAlarm/toHistoryAlarmPage.do', '9', '2', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (12, '告警数据管理', 'alarmData/toAlarmDataPage.do', '9', '3', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (13, '性能管理', '#', '0', '4', 'menu-icon fa fa-bar-chart-o black', '2', 1);
INSERT INTO `sys_menu` VALUES (14, '呼叫详情记录', 'department/listAllDepartment.do?DEPARTMENT_ID=0', '13', '1', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (15, '短消息记录', 'department/listAllDepartment.do?DEPARTMENT_ID=0', '13', '2', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (16, '信道资源占用数据', 'channelResource/toChannelResourceOccupancyPage.do', '13', '3', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (17, '异常业务数据', 'department/listAllDepartment.do?DEPARTMENT_ID=0', '13', '4', 'menu-icon fa fa-users green', '1', 1);
INSERT INTO `sys_menu` VALUES (18, '基站用户负荷数据', 'department/listAllDepartment.do?DEPARTMENT_ID=0', '13', '5', 'menu-icon fa fa-users green', '1', 1);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '系统管理组', '524286', '0');
INSERT INTO `sys_role` VALUES ('2', '一级管理员', '7680', '1');
INSERT INTO `sys_role` VALUES ('3', '二级管理员', '524224', '1');
INSERT INTO `sys_role` VALUES ('4', '三级管理员', '524286', '1');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', 'FH', '', '1', '2018-09-28 17:51:47', '0:0:0:0:0:0:0:1', '0', 'admin', 'default', 'QQ374230654@qq.com', '001', '18347263954');
INSERT INTO `sys_user` VALUES ('2', '1', '17ba0791499db908433b80f37c5fbc89b870084b', '1', '', '2', '2018-09-12 13:46:28', '0:0:0:0:0:0:0:1', '0', '1', 'default', '12345678@qq.com', '1', '18347263954');
...
-- ----------------------------
-- Table structure for tb_carbinet
-- ----------------------------
DROP TABLE IF EXISTS `tb_carbinet`;
CREATE TABLE `tb_carbinet`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pId` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pictureId` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pictureName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pictureLeft` int(11) NULL DEFAULT NULL,
  `pictureTop` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_carbinet
-- ----------------------------
INSERT INTO `tb_carbinet` VALUES ('1', '0', NULL, '系统菜单', NULL, NULL, 0, 0);
INSERT INTO `tb_carbinet` VALUES ('1526530918168', '1', NULL, '机框', 'carbinet1', 'carbinet', 200, 7);
INSERT INTO `tb_carbinet` VALUES ('1526534873987', '1', NULL, '数传服务器', 'dataTransferServer1', 'dataTransferServer', 200, 7);
